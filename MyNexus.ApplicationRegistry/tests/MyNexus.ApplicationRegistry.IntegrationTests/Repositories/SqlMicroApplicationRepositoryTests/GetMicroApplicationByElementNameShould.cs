...
{
    public class GetMicroApplicationByElementNameShould : DbTestBase
    {
        public GetMicroApplicationByElementNameShould() : base(false)
        {
        }
        ...
        public async Task ReturnMicroApplication()
        {
            ...
            // Act
            var app = (await db.GetMicroApplicationByElementName("Tenant 1", "element-name")) as MicroApplication;
        ...
        public async Task ReturnNull()
        {
            ...
            // Act
            var app = await db.GetMicroApplicationByElementName("Tenant 1", "element-name");
