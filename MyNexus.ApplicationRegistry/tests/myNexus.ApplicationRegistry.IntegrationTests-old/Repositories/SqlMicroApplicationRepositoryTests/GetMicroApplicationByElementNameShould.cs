...
namespace MyNexus.ApplicationRegistry.IntegrationTests.Repositories.SqlMicroApplicationRepositoryTests
{
    public class GetMicroApplicationByElementNameShould : DbTestBase
    {
        ...
        public async Task ReturnMicroApplication()
        {
            ...
            // Act
            var app = (await db.GetMicroApplicationByElementName("Edf", "element-name")) as MicroApplication;
        ...
        public async Task ReturnNull()
        {
            ...
            // Act
            var app = await db.GetMicroApplicationByElementName("Edf", "element-name");
